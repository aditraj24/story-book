          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-1">
              ...
              <div className="relative group">
                ...
                >
                  ...
                  <div className="relative">
                    {user?.avatar ? (
                      ...
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 border-white shadow-sm ${avatarColor}`}>
                  ...
                  <svg className="w-4 h-4 text-gray-400 transition-transform group-hover:rotate-180" 
                ...
                {/* Dropdown Menu */}
                <div className="absolute right-0 mt-2 w-64 opacity-0 invisible group-hover:opacity-100 group-hover:visible 
